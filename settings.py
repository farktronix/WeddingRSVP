...
DATABASES = {
    'default': {
        ...
        'NAME': 'farkciscorsvp_new',                      # Or path to database file if using sqlite3.
...
TEMPLATE_DIRS = (
    ...
    '/home/pharkas/rsvp.jacobandmalia.com/rsvp/templates',
    '/Volumes/Data/pharkas/Dropbox/Wedding/website/rsvp_new/templates',
)
